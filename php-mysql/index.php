...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nim && $nama && $alamat && $fakultas) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update mahasiswa set nim = '$nim',nama='$nama',alamat = '$alamat',telepon='$telepon',fakultas='$fakultas' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into mahasiswa(nim,nama,alamat,telepon,fakultas) values ('$nim','$nama','$alamat','$telepon','$fakultas')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
